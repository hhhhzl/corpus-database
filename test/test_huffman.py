...
def main(path):
    ...
    # plt.subplot(121), plt.imshow(src_img, plt.cm.gray), plt.title('pre'), plt.axis('off')
    # plt.subplot(122), plt.imshow(img_decode, plt.cm.gray), plt.title('after'), plt.axis('off')
